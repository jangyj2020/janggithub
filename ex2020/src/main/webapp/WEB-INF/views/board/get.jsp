  ...
  <div class="col-lg-12">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <i class="fa fa-comments fa-fw"></i> 답글&nbsp;(로그인을 하시면 답글쓰기 버튼이 보입니다.)
        <sec:authorize access="isAuthenticated()">
        <button id='addReplyBtn' class='btn btn-primary btn-xs pull-right'><span style="font-size:1.0em;">답글쓰기</span></button>
        </sec:authorize>
      </div>
                ...
                <div class="modal-content">
                   <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                         <h4 class="modal-title" id="myModalLabel">답글쓰기</h4>
                   </div>
